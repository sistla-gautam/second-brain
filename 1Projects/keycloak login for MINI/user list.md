...
#### logging in using the creds
```bash
curl 'https://admin-api-janydx-minicloud.msa.apps.yokogawa.build/tokens' \
  ...
  --data-raw '{"email":"ops@apps.yokogawa.com","password":"s2E^Hp6F15","domain":"janydx-minicloud.msa.apps.yokogawa.build","renewal":false}'
```
